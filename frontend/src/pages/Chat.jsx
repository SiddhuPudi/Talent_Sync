...
function Chat() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-5rem)] sm:min-h-[calc(100vh-8rem)] gap-0 md:gap-5 animate-fade-in font-sans -mx-4 md:mx-0">
      <div className="flex flex-1 gap-0 md:gap-5 h-full overflow-hidden">
              ...
              {selectedUser.connectionStatus !== "accepted" ? (
                ...
                <div className="flex flex-col flex-1 h-full overflow-hidden relative">
                  ...
                  <form
                    ...
                    className="shrink-0 p-2 sm:p-3 md:p-4 bg-bg/80 backdrop-blur-sm border-t border-white/5 flex gap-2 sm:gap-3 items-center sticky bottom-0 z-10"
                  >
                    <input
                      ref={inputRef}
                      value={input}
